# PSBT Howto for DigiByte Core

Since DigiByte Core 0.17, an RPC interface exists for Partially Signed DigiByte
...
PSBT is an interchange format for DigiByte transactions that are not fully signed
...
#### Multisig with multiple DigiByte Core instances

Alice, Bob, and Carol want to create a 2-of-3 multisig address. They're all using
DigiByte Core. We assume their wallets only contain the multisig funds. In case
...
Later, when *V* DGB has been received on *Amulti*, and Bob and Carol want to
