DigiByte-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/bitcoin/files/DigiByte/bitcoin-0.8.4/
...
code, causing the DigiByte-Qt or bitcoind process to crash.
...
their own version of DigiByte against Boost versions 1.50-1.52.
