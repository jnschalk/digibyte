DigiByte Core version 0.13.0 is now available from:
...
proposed parameters, a future release of DigiByte Core is expected that
...
- #8164 `0f24eaf` [DigiByte-Tx] fix missing test fixtures, fix 32bit atoi issue (jonasschnelli)
