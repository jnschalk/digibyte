DigiByte-Qt version 0.8.2 is now available from:
  http://sourceforge.net/projects/bitcoin/files/DigiByte/bitcoin-0.8.2/
...
/Applications/DigiByte-Qt (on Mac) or bitcoind/bitcoin-qt (on Linux).
...
The default fee for low-priority transactions is lowered from 0.0005 DGB 
(for each 1,000 bytes in the transaction; an average transaction is
about 500 bytes) to 0.0001 DGB.

Payments (transaction outputs) of 0.543 times the minimum relay fee
(0.00005430 DGB) are now considered 'non-standard', because storing them
