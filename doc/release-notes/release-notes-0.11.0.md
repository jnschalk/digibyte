DigiByte Core version 0.11.0 is now available from:
...
Block pruning allows DigiByte Core to delete the raw block and undo data once 
...
block index and UTXO databases. The minimum was chosen so that DigiByte Core will 
...
- #5729 `9c4a5a5` Allow unit changes for read-only DigiByteAmountField
...
- #6116 `30dc3c1` [OSX] rename DigiByte-Qt.app to DigiByte-Core.app
