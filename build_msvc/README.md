Building DigiByte Core with Visual Studio
========================================
...
Qt
---------------------
In order to build DigiByte Core a static build of Qt is required. The runtime library version (e.g. v142) and platform type (x86 or x64) must also match.
