...
class HelpTest(DigiByteTestFramework):
    ...
    def run_test(self):
        self.log.info("Start digibyte with -h for help text")
        ...
        self.log.info("Start digibyte with -version for version information")
        ...
        self.log.info("Start digibyted with -fakearg to make sure it does not start")
