...
<<<<<<< HEAD
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 4)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"          (string, required) The DigiByte address (or hex-encoded script)\n"
...
>>>>>>> bitcoin/8.22.0
            ...
            "Note: Use \"getwalletinfo\" to query the scanning progress.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The DigiByte address (or hex-encoded script)"},
...
<<<<<<< HEAD
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"   (string, required) The digibyte address for the private key\n"
            "\nResult:\n"
...
=======
    return RPCHelpMan{"dumpprivkey",
                ...
                "Then the importprivkey can be used with this output\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The digibyte address for the private key"},
                },
                RPCResult{
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
     ...
     * https://github.com/digibyte/digibyte/issues/9934
