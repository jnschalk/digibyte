...
// For details see https://github.com/digibyte/digibyte/pull/22348.
 ...
 * https://github.com/digibyte/digibyte/pull/16097#issuecomment-514627823
 */
...
bool ArgsManager::ParseParameters(int argc, const char* const argv[], std::string& error)
{
    ...
    for (int i = 1; i < argc; i++) {
        ...
        if (key == "-") break; //digibyte-tx using stdin
        std::string val;
