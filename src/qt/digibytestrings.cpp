...
QT_TRANSLATE_NOOP("digibyte-core", "Copyright (C) %i-%i"),
QT_TRANSLATE_NOOP("digibyte-core", "Corrupted block database detected"),
QT_TRANSLATE_NOOP("digibyte-core", "Could not find asmap file %s"),
QT_TRANSLATE_NOOP("digibyte-core", "Could not parse asmap file %s"),
QT_TRANSLATE_NOOP("digibyte-core", "Disk space is too low!"),
QT_TRANSLATE_NOOP("digibyte-core", "Do you want to rebuild the block database now?"),
QT_TRANSLATE_NOOP("digibyte-core", "Done loading"),
QT_TRANSLATE_NOOP("digibyte-core", "Dump file %s does not exist."),
QT_TRANSLATE_NOOP("digibyte-core", "Error creating %s"),
>>>>>>> bitcoin/8.22.0
...
QT_TRANSLATE_NOOP("digibyte-core", "Replaying blocks…"),
QT_TRANSLATE_NOOP("digibyte-core", "Rescanning…"),
QT_TRANSLATE_NOOP("digibyte-core", "SQLiteDatabase: Failed to execute statement to verify database: %s"),
QT_TRANSLATE_NOOP("digibyte-core", "SQLiteDatabase: Failed to prepare statement to verify database: %s"),
