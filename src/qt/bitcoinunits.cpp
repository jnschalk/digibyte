...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case DGB: return QString("Bitcoins");
    case mDGB: return QString("Milli-Bitcoins (1 / 1" THIN_SP_UTF8 "000)");
    case uDGB: return QString("Micro-Bitcoins (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
