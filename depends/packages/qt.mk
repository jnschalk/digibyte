...
$(package)_config_opts_powerpc64_linux = -platform linux-g++ -xplatform digibyte-linux-g++
$(package)_config_opts_powerpc64le_linux = -platform linux-g++ -xplatform digibyte-linux-g++
$(package)_config_opts_riscv64_linux = -platform linux-g++ -xplatform digibyte-linux-g++
$(package)_config_opts_s390x_linux = -platform linux-g++ -xplatform digibyte-linux-g++
...
# digibyte-linux-g++, replace instances of linux-arm-gnueabi with $(host). This
...
>>>>>>> bitcoin/8.22.0
  ...
  cp -r qtbase/mkspecs/linux-arm-gnueabi-g++ qtbase/mkspecs/digibyte-linux-g++ && \
  sed -i.old "s/arm-linux-gnueabi-/$(host)-/g" qtbase/mkspecs/digibyte-linux-g++/qmake.conf && \
<<<<<<< HEAD
  patch -p1 -i $($(package)_patch_dir)/fix_qt_pkgconfig.patch &&\
