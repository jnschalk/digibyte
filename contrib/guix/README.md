# Bootstrappable DigiByte Core Builds

This directory contains the files necessary to perform bootstrappable DigiByte
Core builds.
...
To build DigiByte Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      DigiByte Core version being built.
